...
class Spidermon(object):
    ...
    def __init__(self, crawler,
                 spider_opened_suites=None, spider_closed_suites=None, engine_stopped_suites=None,
    ...
    def from_crawler(cls, crawler):
        ext = cls(
            ...
            engine_stopped_suites=crawler.settings.getlist('SPIDERMON_ENGINE_STOP_MONITORS'),
            ...
            engine_stopped_expression_suites=crawler.settings.getlist('SPIDERMON_ENGINE_STOP_EXPRESSION_MONITORS'),
