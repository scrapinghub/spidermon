...
class SlackMessageAction(ActionWithTemplates):
    ...
    def __init__(self,
        ...
        self.fake_messages = fake_messages or self.fake_messages
    ...
    def from_crawler_kwargs(cls, crawler):
        return {
            ...
            'fake_messages': crawler.settings.get('SPIDERMON_SLACK_FAKE_MESSAGES'),
        }

    def run_action(self):
        if not self.fake_messages:
    ...
    def get_message(self):
        if self.include_message:
            return self._render_template(self.message_template)
        else:
            return None

    def get_attachments(self):
        if self.include_attachments:
            return self._render_template(self.attachments_template)
        else:
            return None
